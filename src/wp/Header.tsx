      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <button
            type="button"
            onClick={onLogout}
            className="h-9 px-3 rounded-xl bg-slate-100 text-slate-600 hover:bg-rose-50 hover:text-rose-600 transition-colors flex items-center gap-2 text-sm font-bold"
            title="Log out"
          >
            <LogOut size={15} />
            Logout
